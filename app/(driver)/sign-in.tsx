  ...
  const onSignInPress = useCallback(async () => {
    ...
    try {
      ...
      if (signInAttempt.status === "complete") {
        ...
        // Route directly to the driver dashboard upon successful sign-in
        router.replace("/(driver)/driverDashboard"); // Directly route to driver dashboard
      } else {
    ...
    <ScrollView className="flex-1 bg-white">
      <View className="flex-1 bg-white">
        ...
        <View className="p-5">
          ...
          <TouchableOpacity onPress={() => router.push("/(driver)/sign-up")} className="mt-10">
